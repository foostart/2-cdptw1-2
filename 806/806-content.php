                                 ...
                                 <li class="col-sm-3">
                                    <ul>
                                        <div  class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner">
                                                <div class="item active">
                                                    <a href="#"><img src="../806/images/logi_base_charging_stand_with_smart_connector_for_ipad_pro_1_large (1).png" class="img-responsive" alt="product 1"></a>
                                 ...
                                 <li class="col-sm-3">
                                    <ul>
                                        <div  class="carousel slide" data-ride="carousel">
                                            <div class="carousel-inner">
                                                <div class="item active">
                                                    <a href="#"><img src="../806/images/imac_1_large.png" class="img-responsive" ></a>                          
                                                    <div class="product_name">
